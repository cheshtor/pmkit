...
func (uc *UserController) CheckLogin() (string, string, []string, func(*fiber.Ctx) error) {
...
func (uc *UserController) GetUser() (string, string, []string, func(*fiber.Ctx) error) {
	var permissions = make([]string, 0)
...
func (uc *UserController) ListUser() (string, string, []string, func(*fiber.Ctx) error) {
	var permissions = make([]string, 0)
...
func (uc *UserController) AddUser() (string, string, []string, func(*fiber.Ctx) error) {
	var permissions = make([]string, 0)
...
func (uc *UserController) UpdateUser() (string, string, []string, func(*fiber.Ctx) error) {
	var permissions = make([]string, 0)
...
func (uc *UserController) ActiveSwitch() (string, string, []string, func(*fiber.Ctx) error) {
	var permissions = make([]string, 0)
